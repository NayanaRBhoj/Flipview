...
public class FlipView extends FrameLayout {
	...
	private static final int PEAK_ANIM_DURATION = 500;// in ms
	private static final int MAX_SINGLE_PAGE_FLIP_ANIM_DURATION = 250;// in ms

	// for normalizing width/height
	private static final int FLIP_DISTANCE_PER_PAGE =180; //= 180;
